...
namespace Chilli
{
	...
	public:
		...
		void SetImageLayout(int Index, VkImageLayout layout) { _Layout[Index] = layout; }
		VkImageLayout GetImageLayout(int Index) { return _Layout[Index]; }
	...
	private:
		...
		VkFormat _Format;
		VkExtent2D _Extent;
		std::vector<VkImageLayout> _Layout;
